...
class TestSmokeTest():
  ...
  def test_nameAndLogoTest(self):
    ...
    self.driver.set_window_size(1383, 1039)
  ...
  def test_adminPageTest(self):
    ...
    self.driver.find_element(By.ID, "password").send_keys("andpassword")
  ...
  def test_joinPageTest(self):
    ...
    self.driver.find_element(By.NAME, "bizname").send_keys("Brigham Young University")
